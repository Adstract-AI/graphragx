"""Knowledge graph dataset scoping for the preparation pipeline."""
...
class KnowledgeGraphDatasetChoice(InitialStepResult):
...
class KnowledgeGraphDatasetScopeResult(StepResult):
    """Metadata-only result describing the scoped KG dataset."""
...
class KnowledgeGraphDatasetScopeStep(
    AbstractStep[KnowledgeGraphDatasetScopeResult, KnowledgeGraphDatasetChoice]
):
    """Select and scope the knowledge graph dataset for the preparation pipeline."""

    def execute_default(
        self,
        context: StepContext[KnowledgeGraphDatasetChoice],
        ...
        return KnowledgeGraphDatasetScopeResult(
    ...
    @staticmethod
    def _get_requested_dataset(context: StepContext[KnowledgeGraphDatasetChoice]) -> str:
